  ...
  <footer class="bg-gray-900" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      ...
      <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
        <div>
          <h3 class="text-sm font-semibold leading-6 text-white">Under Construction:</h3>
          <p class="mt-2 text-sm leading-6 text-gray-300">Data provided 'as-is' without warranty of accuracy.</p>
        </div>
      </div>
      <div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">This is a 21e14 project. ❤️</p>
      </div>
    </div>
  </footer>
</template>
