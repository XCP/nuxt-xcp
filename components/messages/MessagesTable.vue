<template>
  <div>
    ...
    <!-- No Data -->
    <div
      v-else-if="state.messages.length === 0"
      ...
      <TableTemplate class="w-full whitespace-nowrap text-left border-white/10">
        ...
        <thead class="border-b border-white/10 text-base leading-6 text-white">
          <tr>
            <th
              scope="col"
              class="py-2 pr-8 font-semibold"
            >
              Type
            </th>
            <th
              scope="col"
              class="py-2 pl-0 pr-8 font-semibold sm:table-cell"
            >
              Asset
            </th>
            <th
            ...
            <th
              scope="col"
              class="py-2 pl-0 text-right font-semibold sm:table-cell"
            >
              Timestamp
            </th>
          </tr>
        ...
        <tbody class="divide-y divide-white/5">
          ...
          >
            ...
            <td class="py-3 pl-0 pr-8 text-base leading-6 text-gray-300 md:table-cell lg:pr-20">
              <NuxtLink :to="`/address/${item.address}`">
                {{ item.address }}
              </NuxtLink>
            </td>
