<template>
  <div class="dark:bg-gray-800 min-h-screen flex flex-col items-center justify-center text-white max-w-md m-auto">
    <div class="text-center mb-10">
      ...
      <p class="mb-4">
        If you found this website useful and would like to support its ongoing operations you can become a "Blockchain Patron."
      </p>
      <p class="mb-8">
        Your small contribution will help offset the cost of hosting and keep the developer well-caffeinated. ☕
      </p>
      <div class="text-center mb-8">
        ...
        <p class="mt-2">
          1DPPDehtoLLjhXKHibfC3iJVSqwCooivUX
        </p>
      </div>
      <div class="mb-8">
        ...
        <p class="mt-1">
          <a
            href="https://app.usefathom.com/share/fvfgofsg/xcp-io"
            target="_blank"
            class="font-medium hover:underline"
          >Review Web Analytics</a>
        </p>
      </div>
      <div>
        <h2 class="text-2xl font-semibold mb-2">
          How Far Your Sats Can Go
        </h2>
    ...
    <div class="text-center mb-8">
      <h2 class="text-2xl font-semi bold mb-4">
        Months of Hosting Offset
      </h2>
      <div class="flex flex-wrap justify-center gap-2">
        <div
          v-for="n in shownMonths"
          :key="n"
          class="w-16 h-16 flex text-center justify-center items-center text-sm rounded-lg"
          :class="n <= fundedMonths ? 'bg-green-600' : 'bg-transparent border-2 border-green-600'"
        >
          <div class="text-center">
            <div>{{ monthIndexToMonth(n - 1)[0] }}</div>
            <div>{{ monthIndexToMonth(n - 1)[1] }}</div>
          </div>
        </div>
      </div>
    </div>
